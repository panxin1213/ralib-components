...
export default function MessageCode(props) {
  ...
  var inputClass = classNames(_defineProperty({}, "".concat(prefixCls, "-text-input"), buttonType === 'text'));
  var buttonTextClass = classNames((_classNames2 = {}, _defineProperty(_classNames2, "".concat(prefixCls, "-text-button"), buttonType === 'text'), _defineProperty(_classNames2, "".concat(prefixCls, "-button"), true), _classNames2)); // 时间大于 0 发送按钮不可点击
  ...
  }, wrapperProps), /*#__PURE__*/React.createElement(Input, Object.assign({
    className: inputClass,
    placeholder: placeholder
  }, others)), /*#__PURE__*/React.createElement(Button, Object.assign({
