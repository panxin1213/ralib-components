...
import { Cascader, Checkbox, DatePicker, Input, InputNumber, Radio, Select, Switch, TimePicker, Transfer, TreeSelect } from 'antd';
...
export var formElementTypes = [{
  ...
  getComponent: function getComponent(_ref8) {
    var commonProps = _ref8.commonProps,
        props = _ref8.props;
    return /*#__PURE__*/React.createElement(DatePicker.RangePicker, _extends({}, commonProps, {
      picker: "week"
    }, props));
  },
  componentName: 'DatePicker.RangePicker'
...
export function getPlaceholder(_ref14) {
