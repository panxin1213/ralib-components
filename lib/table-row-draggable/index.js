...
var RowElement = (0, _reactSortableHoc.SortableElement)(function (props) {
  return props.children;
});
var BodyContainer = (0, _reactSortableHoc.SortableContainer)(function (props) {
  ...
  return /*#__PURE__*/_react.default.createElement("tbody", others, children2.map(function (item, index) {
    var key = item.key;
    return /*#__PURE__*/_react.default.createElement(RowElement, {
      key: key,
      index: index
    }, item);
  }));
...
function DragRow(OriTable) {
  var DragRowTable = /*#__PURE__*/function (_Component) {
    ...
    function DragRowTable(props) {
      ...
      var BodyWrapper = function BodyWrapper(bodyProps) {
        var injectProps = {
          ...
          helperClass: (0, _classnames.default)(helperClass, 'helper-element')
        };
        return /*#__PURE__*/_react.default.createElement(BodyContainer, _extends({
    ...
    _createClass(DragRowTable, [{
      ...
      value: function render() {
        ...
        var classNames = (0, _classnames.default)(className, 'sxTableRowDraggable');
        return /*#__PURE__*/_react.default.createElement(OriTable, _extends({}, others, {
  ...
  DragRowTable.contextType = _antd.ConfigProvider.ConfigContext;
