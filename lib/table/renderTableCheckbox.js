...
exports.default = renderTableCheckbox;
  ...
  return function WithCheckboxTable(props) {
    ...
    if (checkboxIndex !== false) {
      ...
      var render = function render(value, record, index) {
        return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, renderCell(null, record), /*#__PURE__*/_react.default.createElement("span", {
          style: {
            marginLeft: 8
          }
    ...
    var recordStatusRef = (0, _react.useRef)({}); // 基于 selectedRowKeys 推导选中状态
    ...
    function handleCheck(e, record) {
      ...
      var generationNodes = _record.___generationNodes || (0, _util.findGenerationNodes)(dataSource, key);
    ...
    function setParentsCheckStatus() {
      var loop = function loop(nodes) {
        return nodes.forEach(function (record) {
          ...
          var parentNodes = _record.___parentNodes || (0, _util.findParentNodes)(dataSource, key) || [];
          ...
          _toConsumableArray(parentNodes).reverse().forEach(function (node) {
            ...
            var generationNodes = _node.___generationNodes || (0, _util.findGenerationNodes)(dataSource, nodeKey);
    ...
    function renderCell(_checked, record) {
      ...
      var checkboxProps = getCheckboxProps && getCheckboxProps(record) || {};
      return /*#__PURE__*/_react.default.createElement(_antd.Checkbox, _extends({}, checkboxProps, {
    ...
    var rowClass = (0, _classnames.default)(_defineProperty({}, "".concat(prefixCls, "-row-check"), rowCheck));
    return /*#__PURE__*/_react.default.createElement(WrappedTable, _extends({}, otherProps, {
      columns: nextColumns,
      ...
      rowClassName: function rowClassName(record, index) {
        ...
        return (0, _classnames.default)(rowClass, cls);
      },
